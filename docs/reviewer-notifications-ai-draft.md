...
![投稿表单](../apps/web/public/help-assets/author.jpg)
...
![审题列表](../apps/web/public/help-assets/member.jpg)
...
投稿人粘贴最多 20 万字符/一万行材料，模型只返回原文行号区间，服务器据此提取正文。预览中选择知识点，点击「确认并创建草稿」即可；也可先填入表单继续编辑。标程独立保存到标准程序源码编辑区，语言来自代码围栏，可手动修改；无法分类的原文保留在正式题解中。源码保存失败可重试而不重复建题。不要把提取结果未经检查直接送审；范围选择仍可能有误。
