...
export const initializePasswordInputSchema = z.object({newPassword:z.string().min(12).max(1024)}).strict();
...
export const accountSecurityViewSchema = z.object({ hasPassword: z.boolean(), canChangeCredentials: z.boolean(), canInitializePassword:z.boolean().optional() }).strict();
